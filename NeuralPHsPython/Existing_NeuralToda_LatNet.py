...
# ==================================
# data_raw = np.load(os.path.normpath(os.getcwd() + os.sep + "data" + os.sep + "TodaLat_data_train.npz"))
...
# Load the test data
# ==================================
# data_raw = np.load(os.path.normpath(os.getcwd() + os.sep + "data" + os.sep + "TodaLat_data_test.npz"))
